namespace Azoxia.AdaIsAkademi.Persistence.Mapping
{
    ...
    /// <summary>
    /// EF Core mapping for <see cref="ShiftSupervisor"/> (columns and relationships).
    /// </summary>
    internal sealed class ShiftSupervisorConfiguration :
        EntityTypeConfigurationBase<ShiftSupervisor>
    {
        #region Utils

        /// <inheritdoc />
        protected override void Configure(EntityTypeBuilder<ShiftSupervisor> builder, ref int columnOrder)
        {
